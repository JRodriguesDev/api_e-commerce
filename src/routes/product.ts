...
import {opt_pages_product, opt_create_product, opt_update_product, opt_delete_product, opt_find_product, opt_category_products, opt_search_product} from '../validations/schemas/product.js'
import {db_create_product, db_update_product, db_delete_product, db_category_products, db_search_product} from '#prisma_routes/product.js'
...
export const product = async (fastify: FastifyInstance) => {
    ...
    fastify.get('/search', opt_search_product, async (req, res) => {
        try {
            const {name} = req.query as {name: string}
            const products = await db_search_product(name)
